      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.confirmationTextContainer}>
          <View>
            <Text style={styles.walletText}>
              <Text>You are about to place a bid for </Text>
          ...
          <View>
            ...
            <Text style={styles.warningText}>
              Must be at least 0.00111 PGEM
            </Text>
          </View>
          <View style={styles.balanceContainer}>
            <View style={styles.balanceInnerElements}>
              <Text style={styles.textTitle}>Your bidding balance</Text>
              <Text style={styles.textBalance}>$50.00</Text>
            </View>
            <View style={styles.balanceInnerElements}>
        ...
        <View style={styles.paymentContainer}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <View style={styles.payUsingContainer}>
              <Text style={styles.price}>PLACE A BID </Text>
